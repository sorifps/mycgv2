		...
		<div class="header_menu">
			...
			<c:when test="${sessionScope.svo == null }">
				<ul>
					...
					<li><a href="http://localhost:9000/mypage" target="_parent">마이페이지</a></li>
			 		<li><a href="#">VIP</a></li>
					<li><a href="#">고객센터</a></li>
					...
					<li><a href="http://localhost:9000/admin_index" target="_parent">ADMIN</a></li>
				</ul>
			</c:when>
			<c:otherwise>
				<ul>
					...
					<li><a href="http://localhost:9000/board_list_json" id="JsonBoard">게시판(JSON)</a></li>
