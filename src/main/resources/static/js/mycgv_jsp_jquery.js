	...
	$("#btnIdCheck").click(function(){
		if($("#id").val() == "") {
			...
			$.ajax(
				...
				if(result == 1) {
					$("#idCheck_msg").text("이미 사용중인 아이디입니다. 다시 입력해주세요.").css("color","red").css("font-size","12px").css("display","block")
					.css("padding","5px 0");
					$("#id").val("").focus();
				}else {
					$("#idCheck_msg").text("사용 가능한 아이디입니다.").css("color","blue").css("font-size","12px").css("display","block")
					.css("padding","5px 0");
					$("#pass").focus();
				}
			}});
